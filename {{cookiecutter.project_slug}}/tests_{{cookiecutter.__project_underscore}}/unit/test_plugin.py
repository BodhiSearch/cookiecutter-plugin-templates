from {{ cookiecutter.project_slug }} import {{ cookiecutter.__project_underscore}}_{{ cookiecutter.__service_type}}_service_builder, bodhilib_list_services
...
def test_bohilib_list_services():
    ...
    service = services[0]
    assert service.service_name == "{{ cookiecutter.__service_name }}"
